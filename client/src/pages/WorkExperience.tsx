  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-orange-100 via-white to-orange-50 px-4 sm:px-6 md:px-12 py-12 sm:py-16 mt-20">
      ...
      <motion.h1
        ...
        className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center text-orange-600 mb-10 sm:mb-16 font-serif"
      >
        Work Experience
      </motion.h1>

      {/* Timeline */}
      <div className="relative border-l-4 border-orange-300 ml-4 sm:ml-6 space-y-10 sm:space-y-12">
        {experiences.map((exp, idx) => (
          ...
          >
            {/* Icon */}
            <div className="absolute -left-6 sm:-left-7 top-2 bg-white border-2 border-orange-500 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center shadow-md">
              {exp.icon}
            </div>

            {/* Card */}
            <div className="bg-white/70 backdrop-blur-md rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition border border-orange-100">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                ...
                {exp.linkedin && (
                  <a
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-[#0A66C2] text-[#0A66C2] text-xs sm:text-sm font-medium hover:bg-[#0A66C2]/10 transition w-fit"
                  >
              ...
              <p className="text-xs sm:text-sm text-gray-600 mb-1 sm:mb-2">{exp.year}</p>
              <p className="text-sm sm:text-base text-gray-700 mb-4">{exp.desc}</p>
